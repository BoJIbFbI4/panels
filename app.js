...
app.controller(
  ...
  [
    ...
    function ($rootScope, $scope, $stateParams, serviceButtons, translationService, $mdDialog, $state, modalService) {

        serviceButtons.setUrl("https://panel-repatriation.rhcloud.com");
