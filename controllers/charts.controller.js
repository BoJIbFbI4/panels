...
angular.module('panelsApp')
    .controller('ChartsCtrl', ['$scope', '$rootScope', '$http', '$state', '$filter', 'fileUpload', '$stateParams', 'getChartData', '$mdDialog', 'serviceButtons',
                        ...
                        var donutChart = c3.generate({
                            ...
                            data: {
                                ...
                                onclick: function (d, i) {
                                    ...
                                    return getChartData.getAnalisysByCities(questionID, $scope.createDate, $scope.userDate).then(function (response) {
